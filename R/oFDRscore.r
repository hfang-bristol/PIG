...
#' @note none
#' @export
#' @seealso \code{\link{dSVDsignif}}, \code{\link{oNetPipeline}}
#' @include oFDRscore.r
#' @examples
...
#' # no fdr threshold
#' scores <- oFDRscore(fdr)
#' # using fdr threshold of 0.01
#' scores <- oFDRscore(fdr, fdr.threshold=0.1, scatter=TRUE)

oFDRscore <- function(fdr, fdr.threshold=NULL, scatter=F)
{
