...
#' ap <- oPvalAggregate(pmatrix, method="orderStatistic")
#'
#' # 3) aggregate according to the Fisher's method
#' ap <- oPvalAggregate(pmatrix, method="fishers") 
#'
#' # 4) aggregate according to the Z-transform method
#' ap <- oPvalAggregate(pmatrix, method="Ztransform")
#' 
#' # 5) aggregate according to the logistic method
#' ap <- oPvalAggregate(pmatrix, method="logistic")

oPvalAggregate <- function(pmatrix, method=c("orderStatistic", "fishers", "Ztransform", "logistic"), order=ncol(pmatrix), weight=rep(1,ncol(pmatrix))) 
{
