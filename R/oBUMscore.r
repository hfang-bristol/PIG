...
#' # using "pdf" method
#' scores <- oBUMscore(fit, method="pdf", fdr=0.01)
#' # using "cdf" method
#' scores <- oBUMscore(fit, method="cdf", fdr=0.01)

oBUMscore <- function(fit, method=c("pdf","cdf"), fdr=NULL, scatter.bum=T)
{
